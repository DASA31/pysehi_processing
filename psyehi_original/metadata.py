...
def metadata_params(data, parameter=None, parameter_false=None,readable=True, write=False):
    ...
    parameter_false (str or list, optional): Exclude these parameters. The default is None.
    readable (bool, optional): DESCRIPTION. The default is True.
    write (bool, optional): Writes the human readable summary in the data folder. The default is False.
